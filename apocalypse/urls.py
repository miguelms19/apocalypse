...
urlpatterns = [
    ...
    path('gallery/commandpost', views.commandpost_gal, name='commandpost_gallery'),
    path('gallery/village', views.village_gal, name='village_gallery'),
    path('gallery/safezone', views.safezone_gal, name='safezone_gallery'),
    path('gallery/outlining', views.outlining_gal, name='outlining_gallery'),
    path('gallery/trenches', views.trenches_gal, name='trenches_gallery'),
    path('gallery/under18', views.under18_gal, name='under18_gallery'),
